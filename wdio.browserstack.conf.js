...
export const config = {
  ...
  baseUrl: `https://sc-test-3.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `sc-test-3-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `sc-test-3-${process.env.ENVIRONMENT}`
        },
